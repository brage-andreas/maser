...
const singletonConnection = postgres()(
	"postgres://postgres:admin@localhost:5432/maser"
);
...
export default class PostgresConnection {
	...
	public async oneOrNone<T extends Exclude<PostgresResponses, PostresExists>>(
		query: string
	): Promise<T | null> {
